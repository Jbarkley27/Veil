...
namespace Infohazard.HyperNav.Editor {
    ...
    public static class MarchingCubesTables {
        ...
        /// </summary>
        public static readonly byte[,] EdgeToVertexIndices = {
            {0, 1},
            {1, 2},
            {2, 3},
            {3, 0},
        ...
        /// </summary>
        public static readonly Vector3Int[] PositiveDirections = {
        ...
        /// </summary>
        public static readonly byte[] AcrossCenterMidpoints = {
            6,
            7,
            4,
            5,
        ...
        /// <summary>
        /// This table maps the index of a direction in <see cref="PositiveDirections"/>
        /// to a list of vertices on the positive side of that direction.
        /// </summary>
        public static readonly byte[][] VerticesOnSideAPerDirection = {
            new byte[] { 0, 3, 7, 4 },
            new byte[] { 0, 1, 2, 3 },
            new byte[] { 0, 1, 5, 4 },
        };
        ...
        /// </summary>
        public static readonly byte[][] VerticesOnSideBPerDirection = {
            new byte[] { 1, 2, 6, 5 },
            new byte[] { 4, 5, 6, 7 },
            new byte[] { 2, 3, 7, 6 },
        };
